    ...
    content : [
        {
            ...
            content: {
                ...
                content: [
                    ...
                    { block: 'movable', type: 'bean-bag' },
                    { block: 'movable', type: 'bean-bag' },
                    { block: 'movable', type: 'tv' },
                    { block: 'movable', type: 'tree' },
                    { block: 'movable', type: 'tree' }
                ]
            }
        },
            ...
            content: [
                {
                    ...
                    content: {
                        block: 'legend',
                        text: [
                            'Управление мышкой или клавишами курсора (→, ←, ↑, ↓), space — повернуть. Без shift смещение на 5px, с shift — 1px.',
